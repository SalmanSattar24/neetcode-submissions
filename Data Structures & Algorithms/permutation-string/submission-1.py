...
class Solution:
    def checkInclusion(self, s1: str, s2: str) -> bool:
        ...
        combined with frequency maps (counters). We maintain a fixed-size window
        in s2 (equal to the length of s1) and compare its character frequencies
        with the frequencies of characters in s1.

        Args:
            s1: The string whose permutation we are looking for.
